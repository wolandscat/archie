...
msgmerge --no-wrap --sort-output --backup=none --lang=nl -U ./po/i18n_nl.po ./po/keys.pot
msgmerge --no-wrap --sort-output --backup=none --lang=en -U ./po/i18n_en.po ./po/keys.pot
